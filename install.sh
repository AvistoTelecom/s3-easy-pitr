#!/bin/sh
# Copied from https://github.com/release-lab/install/raw/refs/heads/v1/install.sh
...
TEMP_DIR=$(mktemp -d)
tar -xz -f ${downloaded_file} -C ${TEMP_DIR}
mv ${TEMP_DIR}/${exe_name} ${executable_folder}/
